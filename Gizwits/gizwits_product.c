...
extern int MQ2_flag,Heat_flag,MQ5_flag,MQ9_flag;
extern uint16_t Heat,MQ2,MQ5,MQ9;
extern int MQ2_threshold,MQ5_threshold,MQ9_threshold,fire_threshold;
  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      ...
      case EVENT_fire_threshold:
        ...
        //user handle
        break;
      case EVENT_mq5_threshold:
        currentDataPoint.valuemq5_threshold = dataPointPtr->valuemq5_threshold;
        GIZWITS_LOG("Evt:EVENT_mq5_threshold %d\n",currentDataPoint.valuemq5_threshold);
        //user handle
        break;
...
{
     currentDataPoint.valueHeat = Heat;//Add Sensor Data Collection
    currentDataPoint.valueMQ2 =MQ2;//Add Sensor Data Collection
    currentDataPoint.valueMQ9 =MQ9;//Add Sensor Data Collection
    currentDataPoint.valueMQ5 =MQ5;//Add Sensor Data Collection
    currentDataPoint.valueHeat_flag =Heat_flag;//Add Sensor Data Collection
    ...
    MQ2_threshold=currentDataPoint.valuesmoke_threshold;
		MQ5_threshold=currentDataPoint.valuemq5_threshold;
...
void userInit(void)
{
    ...
    /*
      ...
      currentDataPoint.valueMQ9 = ;
      currentDataPoint.valueMQ5 = ;
      currentDataPoint.valueHeat_flag = ;
