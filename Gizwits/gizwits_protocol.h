...
* @{
*/
#define PRODUCT_KEY "d14c106eb16e430e9fb8d5c1622d94c1"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "69dac529e7ae459e9a41ac348f0ef47a"
...
#define Heat_flag_BYTEOFFSET                    17
#define Heat_flag_BITOFFSET                     0
#define Heat_flag_LEN                           1
#define MQ2_flag_BYTEOFFSET                    17
#define MQ2_flag_BITOFFSET                     1
#define MQ2_flag_LEN                           1
#define MQ5_flag_BYTEOFFSET                    17
#define MQ5_flag_BITOFFSET                     2
#define MQ5_flag_LEN                           1
#define MQ9_flag_BYTEOFFSET                    17
#define MQ9_flag_BITOFFSET                     3
#define MQ9_flag_LEN                           1
...
#define mq5_threshold_RATIO                         1
#define mq5_threshold_ADDITION                      0
#define mq5_threshold_MIN                           0
#define mq5_threshold_MAX                           500
#define mq9_threshold_RATIO                         1
#define mq9_threshold_ADDITION                      0
#define mq9_threshold_MIN                           0
#define mq9_threshold_MAX                           500
#define Heat_RATIO                         1
#define Heat_ADDITION                      0
#define Heat_MIN                           0
#define Heat_MAX                           1000
#define MQ2_RATIO                         1
#define MQ2_ADDITION                      0
#define MQ2_MIN                           0
#define MQ2_MAX                           1000
#define MQ9_RATIO                         1
#define MQ9_ADDITION                      0
#define MQ9_MIN                           0
#define MQ9_MAX                           1000
#define MQ5_RATIO                         1
#define MQ5_ADDITION                      0
#define MQ5_MIN                           0
#define MQ5_MAX                           1000
/**@} */
...
typedef struct {
  ...
  uint32_t valuemq5_threshold;
  uint32_t valuemq9_threshold;
  uint32_t valueHeat;
  uint32_t valueMQ2;
  uint32_t valueMQ9;
  uint32_t valueMQ5;
...
typedef struct {
  ...
  uint8_t flagmq5_threshold:1;
  uint8_t flagmq9_threshold:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valuemq5_threshold;
  uint16_t valuemq9_threshold;
} attrVals_t;
